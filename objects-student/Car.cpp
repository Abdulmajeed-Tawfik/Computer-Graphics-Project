...
car::car()
{
	...
	frontshape->setDeformation(2.0, 1.0, 3.0);
	frontshape->setPosition(4.0, 4.2, 0.0);
	...
	//container = new cube;
	//container->setColour(0.0, 1.0, 0.0, 1.0);
	//container->setParent(base);
	//container->setPosition(0.0, 0.5, 0.0);
...
void car::moveX(int x, float t, int dir) {
	// If statement to limit the user to initialize x as 1 or -1

	base->setPosition(x + dir*t, 0, 0);

}

void car::reverse(int x, float t) {

	moveX(x, t, 1);
}
		
void car::accelerate(int x, float t) {
...
//void car::accelerateB(double t, int direction) {
//	for (int i = 0; i < t; i++)
//	{
//		base->setPosition(t * direction, 0.0, 0.0);
//	}
//
//}

//void car::turnRL(double t) {
//	for (int i = 0; i < t; i++)
//	{
//		base->setPosition(0.0, 0.0, t);
//	}
//}